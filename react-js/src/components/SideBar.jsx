        ...
        <div className='sideBar-container'>
          ...
          <div className="form-group text-center user-avatar" style={{ position: 'relative' }} >
            <span className="img-div">
              <div className="text-center img-placeholder" onClick={this.clickImage}>
                <h4>Update image</h4>
              </div>
              <img src={this.state.url || this.state.avartarUrl} onClick={this.clickImage} id="profileDisplay" />
            </span>
          ...
          <Menu theme="dark" mode="inline" defaultSelectedKeys={[`/${this.props.location.pathname.split('/')[1]}`]} >
            ...
            >
              <img src={userImage} alt="aaa" style={{ height: '32px', width: '32px' }} />
            ...
            >
              <img src={passImage} alt="aaa" style={{ height: '32px', width: '32px' }} />
            ...
            >
              <img src={cartImage} alt="aaa" style={{ height: '32px', width: '32px' }} />
            ...
            >
              <img src={likeProductImage} alt="aaa" style={{ height: '32px', width: '32px' }} />
